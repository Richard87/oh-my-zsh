...
```shell
sh -c "$(curl -fsSL https://raw.githubusercontent.com/Richard87/oh-my-zsh/master/tools/install.sh)"
```
...
```shell
git clone https://github.com/robbyrussell/ohmyzsh.git ~/.oh-my-zsh
```
