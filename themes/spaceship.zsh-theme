...
# GIT STATUS
SPACESHIP_GIT_STATUS_SHOW="${SPACESHIP_GIT_STATUS_SHOW:=false}"
...
# PHP
SPACESHIP_PHP_SHOW="${SPACESHIP_PHP_SHOW:=false}"
...
# RUST
SPACESHIP_RUST_SHOW="${SPACESHIP_RUST_SHOW:=false}"
...
# JULIA
SPACESHIP_JULIA_SHOW="${SPACESHIP_JULIA_SHOW:=false}"
